...
- :class:`SmartMusicalChair` is another approach, similar to :class:`rhoRandSticky` and :class:`MusicalChair`, but we hope it will be better, and we succeed in analyzing more easily.
...
from .SmartMusicalChair import SmartMusicalChair  # New version, still experimental!
