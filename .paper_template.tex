...
\pagestyle{fancy}
    ...
    \lhead{\emph{$title$} presentation paper}
    \rhead{\emph{\today}}
    \lfoot{\href{https://GitHub.com/Naereen/AlgoBandits}{GitHub.com/Naereen/AlgoBandits}}
...
\lstset{%
  ...
  basicstyle=\ttfamily\small, % \texttt\small,              % the size of the fonts that are used for the code, FIXME \ttfamily
