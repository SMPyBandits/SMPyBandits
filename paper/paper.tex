...
lower-bound). For instance, Thomson sampling is very efficient in average (in \textcolor{gold}{yellow}), and UCB shows a much larger variance (in \textcolor{red}{red}).\label{fig:plot1}}
\end{figure}
