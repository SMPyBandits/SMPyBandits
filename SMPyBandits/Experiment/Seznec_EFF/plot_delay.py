...
def plot_h_omega(N=100):
  ...
  plt.plot(M, max, '.', label='max', markersize=2, linewidth=1, alpha=0.1)
  plt.plot(M, mean, '.', label='average', markersize=2, linewidth=1, alpha=0.1)
  plt.plot(M, median, '.', label='median', markersize=2, linewidth=1, alpha=0.1)
  plt.plot(M, min, '.', label='min', markersize=2, linewidth=1, alpha=0.1)
  leg = plt.legend(bbox_to_anchor=(-0.07, 0.4), markerscale=10)
