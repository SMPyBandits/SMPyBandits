...
# Local imports
from Environment import EvaluatorSparseMultiPlayers, notify
from configuration_sparse_multiplayers import configuration
...
if __name__ == '__main__':
    ...
    # List to keep all the EvaluatorSparseMultiPlayers objects
    ...
    # Done
    print("Done for simulations main_sparse_multiplayers.py ...")
    notify("Done for simulations main_sparse_multiplayers.py ...")
